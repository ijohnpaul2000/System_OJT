            ...
            <Row className="mb-3">
              <Col>
                ...
                <InputGroup className="mb-2">
                  <Form.Control
                    type="text"
                    onChange={(e) => setMember_b(e.target.value)}
                ...
                <InputGroup className="mb-2">
                  <Form.Control
                    type="text"
                    onChange={(e) => setMember_c(e.target.value)}
                ...
                <InputGroup className="mb-2">
                  <Form.Control
                    type="text"
                    onChange={(e) => setMember_d(e.target.value)}
              ...
              <Col>
                ...
                <InputGroup className="mb-2">
                  <Form.Control
                    type="text"
                    onChange={(e) => setPanel_b(e.target.value)}
                    placeholder="Panel 2"
                  />
                </InputGroup>
                ...
                <InputGroup className="mb-2">
                  <Form.Control
                    type="text"
                    onChange={(e) => setPanel_c(e.target.value)}
                    placeholder="Panel 3"
                  />
                </InputGroup>
                ...
                <InputGroup className="mb-2">
                  <Form.Control
                    type="text"
                    onChange={(e) => setPanel_d(e.target.value)}
                    placeholder="Panel 4"
                  />
                </InputGroup>
              </Col>
